...
datafile = 'C:/Users/Administrator/Desktop/chapter6/demo/data/model.xls'
...
netfile = 'C:/Users/Administrator/Desktop/net.model' #构建的神经网络模型存储路径
#print(train[:,0:3])
...
net.fit(train[:,0:3], train[:,3], epochs=5, batch_size=1) #训练模型，循环1000次
